/*
    ...
    Description: Provides a place for users to change their app settings.
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainMenu menuActivity = (MainMenu) getActivity();

        // set checkboxes based on current settings
        CheckBox box = (CheckBox) inflated.findViewById(R.id.gpsCheckBox);
        box.setChecked(menuActivity.enableGPS);
        box = (CheckBox) inflated.findViewById(R.id.loggingCheckBox);
        box.setChecked(menuActivity.enableLogging);
        return inflated;
    }
